...
interface IDividendTrackerDeployer {
    function deploy(address creator, address impleToken, bytes memory params) external returns (address);
}
...
contract SafuDeployerTemplate2 is Context, Ownable, ISafuDeployerTemplate2 {
